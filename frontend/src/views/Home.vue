  ...
  <div class="home-container">
    <div class="header">
      <div class="glitch-wrapper">
        <h1 class="glitch-title">shandian AI超级智能体</h1>
      </div>
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/travel-master')">
        ...
        <div class="app-icon travel-icon">❤️</div>
        <div class="app-info">
          <div class="app-title">南京旅游咨询</div>
          <div class="app-desc">智能旅游顾问，帮你解答各种旅游问题</div>
        </div>
...
// 设置页面标题和元数据
useHead({
  title: 'shandian AI超级智能体应用平台 - 首页',
  meta: [
    {
      name: 'description',
      content: 'shandian AI超级智能体应用平台提供AI南京旅游咨询和AI超级智能体服务，满足您的各种AI对话需求'
    },
    {
      name: 'keywords',
      content: 'AI智能体,AI应用,AI南京旅游咨询,AI助手,智能对话,shandian,AI超级智能体,首页'
    }
  ]
})
